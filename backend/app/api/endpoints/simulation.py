...
async def simulate_scenario(
    params: SimulationParams, events: SimulationEvents
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        results = {"supply": [], "price": [], "liquidity": [], "event_logs": []}
        ...
        for month in range(params.simulation_months):
            ...
            for event in month_events:
                ...
                if current_supply > 0:
                    current_price = (
                        params.initial_supply * params.initial_price
                    ) / current_supply
            ...
            monthly_results = simulate_tokenomics(
                current_supply, current_price, current_liquidity, params
            )
