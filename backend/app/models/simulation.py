...
class TokenPoint(BaseTokenomicsModel):
    ...
    circulating_supply: Optional[Decimal] = Field(None, description="Circulating token supply")
    ...
    rewards_distributed: Optional[Decimal] = Field(None, description="Total rewards distributed") 